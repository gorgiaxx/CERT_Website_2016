...
if (isset($_GET['delete'])) {
	...
	if ($current_id != '') {
		$s = $wpdb->query("DELETE FROM wp_department WHERE id in (" . $current_id . ")");
	}
	redirect();
} else {
	if (isset($_GET['edit'])) {
			...
			<form action="" method="post" class="edit-template-form">
				...
				<table class="form-table">
					...
					<tr valign="top">
						...
						<td>
							<img id="upload_background" src="<?php echo @$depart->background; ?>" style="width: 320px;height: auto;" alt="点击上传">*
